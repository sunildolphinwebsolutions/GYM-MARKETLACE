    ...
    const ownerLinks = [
        ...
        },
        {
            name: 'Payouts', href: '/dashboard/payouts', icon: (
                <svg className={`mr-3 h-5 w-5 ${isActive('/dashboard/payouts') ? 'text-black' : 'text-gray-400 group-hover:text-gray-300'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    return (
        <div className="min-h-screen bg-black text-white font-sans">
            ...
            <div className="min-h-screen flex flex-col md:pt-16">
                ...
                <header className="bg-gray-900 border-b border-gray-800 shadow-sm h-16 flex items-center justify-between px-6 sticky top-0 z-20 md:hidden">
                    <div className="font-semibold text-brand-yellow">{user.role === 'gym_owner' ? 'Owner Portal' : 'User Dashboard'}</div>
